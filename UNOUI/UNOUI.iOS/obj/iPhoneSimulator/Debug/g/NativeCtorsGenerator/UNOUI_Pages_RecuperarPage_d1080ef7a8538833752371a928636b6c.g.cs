...
namespace UNOUI.Pages
{
	...
	partial class RecuperarPage
	{
		...
		/// </remarks>
		public RecuperarPage(IntPtr javaReference, global::Android.Runtime.JniHandleOwnership transfer) : base (javaReference, transfer) { }
#endif
#if __IOS__ || __MACOS__
		/// <summary>
		/// Native constructor, do not use explicitly.
		...
		/// objects that may have been collected in the managed world.
		/// </remarks>
		public RecuperarPage(IntPtr handle) : base (handle) { }
#endif
	}
}
